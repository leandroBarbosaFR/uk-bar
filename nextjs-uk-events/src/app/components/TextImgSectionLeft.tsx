  ...
  return (
    <section>
      <div className="gap-8 grid grid-cols-12">
        <h1 className="col-span-12 row-start-2 text-4xl sm:text-7xl md:text-8xl lg:text-[200px] font-bold whitespace-normal sm:whitespace-nowrap">
        ...
        <div className="col-start-1 col-end-12 row-start-4 lg:col-start-2 lg:col-end-7 lg:row-start-3 text-[#33483e] text-1xl sm:text-4xl md:text-4xl lg:text-[24px] item-description">
          <PortableText value={TextImgSectionLeft.body} />
        </div>
        <div className="col-start-2 col-end-11 row-start-3 lg:col-start-7 lg:col-end-12 lg:row-start-3">
          {TextImgSectionLeft.image && (
            <Image
              width={7172}
              height={7172}
              src={urlFor(TextImgSectionLeft.image).width(7172).url()}
              alt="Hero image"
